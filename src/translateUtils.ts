...
const REGION_ROOTS: Record<string, { ko: string; en: string }> = {
  ...
  // 주요 지진 다발 시/군/구 지명 (이와테, 미야기, 후쿠시마, 이바라키, 지바, 홋카이도 등)
  '一関市千厩町': { ko: '이치노세키시 센마야정', en: 'Ichinoseki-shi Senmaya-cho' },
  '一関市東山町': { ko: '이치노세키시 히가시야마정', en: 'Ichinoseki-shi Higashiyama-cho' },
  '気仙沼市赤岩': { ko: '케센누마시 아카이와', en: 'Kesennuma-shi Akaiwa' },
  '一関市': { ko: '이치노세키시', en: 'Ichinoseki City' },
  '一関': { ko: '이치노세키', en: 'Ichinoseki' },
  '千厩': { ko: '센마야', en: 'Senmaya' },
  '東山町': { ko: '히가시야마정', en: 'Higashiyama-cho' },
  '東山': { ko: '히가시야마', en: 'Higashiyama' },
  '気仙沼市': { ko: '케센누마시', en: 'Kesennuma City' },
  '気仙沼': { ko: '케센누마', en: 'Kesennuma' },
  '赤岩': { ko: '아카이와', en: 'Akaiwa' },
  '大船渡市': { ko: '오후나토시', en: 'Ofunato City' },
  '大船渡': { ko: '오후나토', en: 'Ofunato' },
  '陸前高田市': { ko: '리쿠젠타카타시', en: 'Rikuzentakata City' },
  '陸前高田': { ko: '리쿠젠타카타', en: 'Rikuzentakata' },
  '釜石市': { ko: '가마이시시', en: 'Kamaishi City' },
  '釜石': { ko: '가마이시', en: 'Kamaishi' },
  '宮古市': { ko: '미야코시', en: 'Miyako City' },
  '久慈市': { ko: '쿠지시', en: 'Kuji City' },
  '久慈': { ko: '쿠지', en: 'Kuji' },
  '石巻市': { ko: '이시노마키시', en: 'Ishinomaki City' },
  '石巻': { ko: '이시노마키', en: 'Ishinomaki' },
  '登米市': { ko: '도메시', en: 'Tome City' },
  '登米': { ko: '도메', en: 'Tome' },
  '栗原市': { ko: '구리하라시', en: 'Kurihara City' },
  '栗原': { ko: '구리하라', en: 'Kurihara' },
  '大崎市': { ko: '오사키시', en: 'Osaki City' },
  '大崎': { ko: '오사키', en: 'Osaki' },
  '仙台市': { ko: '센다이시', en: 'Sendai City' },
  '仙台': { ko: '센다이', en: 'Sendai' },
  '名取市': { ko: '나토리시', en: 'Natori City' },
  '名取': { ko: '나토리', en: 'Natori' },
  '岩沼市': { ko: '이와누마시', en: 'Iwanuma City' },
  '角田市': { ko: '가쿠다시', en: 'Kakuda City' },
  '白石市': { ko: '시로이시시', en: 'Shiroishi City' },
  '花巻市': { ko: '하나마키시', en: 'Hanamaki City' },
  '花巻': { ko: '하나마키', en: 'Hanamaki' },
  '北上市': { ko: '기타카미시', en: 'Kitakami City' },
  '北上': { ko: '기타카미', en: 'Kitakami' },
  '遠野市': { ko: '도노시', en: 'Tono City' },
  '遠野': { ko: '도노', en: 'Tono' },
  '奥州市': { ko: '오슈시', en: 'Oshu City' },
  '奥州': { ko: '오슈', en: 'Oshu' },
  '盛岡市': { ko: '모리오카시', en: 'Morioka City' },
  '盛岡': { ko: '모리오카', en: 'Morioka' },
  '八戸市': { ko: '하치노헤시', en: 'Hachinohe City' },
  '八戸': { ko: '하치노헤', en: 'Hachinohe' },
  '十和田市': { ko: '도와다시', en: 'Towada City' },
  '十和田': { ko: '도와다', en: 'Towada' },
  '三沢市': { ko: '미사와시', en: 'Misawa City' },
  'いわき市': { ko: '이와키시', en: 'Iwaki City' },
  'いわき': { ko: '이와키', en: 'Iwaki' },
  '相馬市': { ko: '소마시', en: 'Soma City' },
  '相馬': { ko: '소마', en: 'Soma' },
  '南相馬市': { ko: '미나미소마시', en: 'Minamisoma City' },
  '南相馬': { ko: '미나미소마', en: 'Minamisoma' },
  '郡山市': { ko: '고리야마시', en: 'Koriyama City' },
  '郡山': { ko: '고리야마', en: 'Koriyama' },
  '会津若松市': { ko: '아이즈와카마쓰시', en: 'Aizuwakamatsu City' },
  '会津若松': { ko: '아이즈와카마쓰', en: 'Aizuwakamatsu' },
  '福島市': { ko: '후쿠시마시', en: 'Fukushima City' },
  '水戸市': { ko: '미토시', en: 'Mito City' },
  '日立市': { ko: '히타치시', en: 'Hitachi City' },
  'つくば市': { ko: '쓰쿠바시', en: 'Tsukuba City' },
  '銚子市': { ko: '조시시', en: 'Choshi City' },
  '旭市': { ko: '아사히시', en: 'Asahi City' },
  '輪島市': { ko: '와지마시', en: 'Wajima City' },
  '珠洲市': { ko: '스주시', en: 'Suzu City' },
  '七尾市': { ko: '나나오시', en: 'Nanao City' },
  '穴水町': { ko: '아나미즈정', en: 'Anamizu-machi' },
  '能登町': { ko: '노토정', en: 'Noto-cho' },
};

// 3. 접미사/위치/방향 사전 (정규식 기반 치환) - 우선순위를 위해 긴 단어부터 배열
const MODIFIERS_KO: [RegExp, string][] = [
  [/東南東/g, ' 동남동'], [/西南西/g, ' 서남서'], [/東北東/g, ' 동북동'], [/西北西/g, ' 서북서'],
  [/南東/g, ' 남동'], [/南西/g, ' 남서'], [/北東/g, ' 북동'], [/北西/g, ' 북서'],
  [/南部/g, ' 남부'], [/北部/g, ' 북부'], [/東部/g, ' 동부'], [/西部/g, ' 서부'], [/中部/g, ' 중부'],
  // 주의: 단독 한자 (東, 西, 南, 北)는 고유명사 한자(東山, 北上 등)를 깨뜨리므로 '앞바다', '연안', '방향' 뒤에 결합된 형태만 치환
